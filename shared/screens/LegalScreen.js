...
Street Plate is a trading name of KulaConnect (Pty) Ltd ("we", "us", or "our"), a company registered in the Republic of South Africa. We operate the Street Plate mobile applications. This policy explains how we collect, use, and protect your personal information.
...
7. YOUR RIGHTS
You have the right to access, correct, or delete your personal data. Contact us at privacy@streetplate.co.za.

8. CONTACT
Street Plate (a trading name of KulaConnect (Pty) Ltd)
Email: privacy@streetplate.co.za
Website: https://streetplate.co.za`;

const TERMS_OF_SERVICE = `Last updated: June 2025

Please read these Terms of Service carefully before using Street Plate.

These Terms constitute a binding agreement between you and KulaConnect (Pty) Ltd, trading as Street Plate, a company registered in the Republic of South Africa.

1. ACCEPTANCE OF TERMS
By downloading or using the Street Plate app, you agree to these terms. If you do not agree, do not use the app.

2. THE SERVICE
Street Plate is a food ordering platform that connects customers with local food vendors. We facilitate the ordering and delivery process but are not the food vendor.
...
- Refund requests must be submitted within 24 hours of the scheduled delivery time. Contact support@streetplate.co.za with your order number and reason.
...
- Street Plate is not liable for delays caused by circumstances beyond our control.
...
By registering as a vendor on Street Plate, you agree to the following:
...
- Street Plate retains a 15% commission on all completed orders. Vendors receive 85% of the order value, paid out weekly to the bank account on file.
- Street Plate reserves the right to suspend or remove vendors who repeatedly violate food safety, quality, or platform standards.
...
By registering as a driver on Street Plate, you confirm and agree to the following:
...
- Your vehicle is roadworthy and covered by valid vehicle insurance. Street Plate is not liable for any accidents, injuries, or damages arising from your use of a vehicle while making deliveries.
- You operate as an independent contractor, not an employee of Street Plate.
- You must comply with all traffic laws and road safety regulations at all times.

9. PROHIBITED CONDUCT
You may not use Street Plate to engage in fraud, harassment, or any illegal activity. Accounts found in violation will be suspended.

10. LIMITATION OF LIABILITY
To the maximum extent permitted by law, Street Plate is not liable for indirect, incidental, or consequential damages arising from use of our service. Our total liability to you shall not exceed the value of the order in dispute.
